...
var EventCaptureMixin = {
	...
	compssssonentWillMount() {
		var innerDimensions = this.getInnerDimensions(this.context);
		...
		if (this.doesContainChart()) {
			...
			console.log(Object.keys(passThroughProps));
...
*/					//var newXScale = this.updateXScaleDomain(chart.scales.xScale, [domainL, domainR])
	...
	componentWillReceiveProps(nextProps, nextContext) {
		var innerDimensions = this.getInnerDimensions(nextContext);
