...
var _EachFibRetracement = require("./wrapper/EachFreeLine");
...
var FreeFreeLine = function (_Component) {
	_inherits(FreeFreeLine, _Component);

	function FreeFreeLine(props) {
		_classCallCheck(this, FreeFreeLine);

		var _this = _possibleConstructorReturn(this, (FreeFreeLine.__proto__ || Object.getPrototypeOf(FreeFreeLine)).call(this, props));
	...
	_createClass(FreeFreeLine, [{
		...
		value: function render() {
			...
			var hoverTextWidthDefault = _extends({}, FreeFreeLine.defaultProps.hoverText, hoverText);
...
exports.default = FreeFreeLine;
//# sourceMappingURL=FreeFreeLine.js.map