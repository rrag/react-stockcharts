...
var _EachFibRetracement = require("./wrapper/EachVerticalLine");
...
var VerticalLine = function (_Component) {
	_inherits(VerticalLine, _Component);

	function VerticalLine(props) {
		_classCallCheck(this, VerticalLine);

		var _this = _possibleConstructorReturn(this, (VerticalLine.__proto__ || Object.getPrototypeOf(VerticalLine)).call(this, props));
	...
	_createClass(VerticalLine, [{
		...
		value: function render() {
			...
			var hoverTextWidthDefault = _extends({}, VerticalLine.defaultProps.hoverText, hoverText);
