...
var _EachFibRetracement = require("./wrapper/EachHorizontalLine");
...
var HorizontalLine = function (_Component) {
	...
	_createClass(HorizontalLine, [{
		...
		value: function render() {
			...
			var hoverTextWidthDefault = _extends({}, HorizontalLine.defaultProps.hoverText, hoverText);
