...
var EachFreeLine = function (_Component) {
	_inherits(EachFreeLine, _Component);

	function EachFreeLine(props) {
		_classCallCheck(this, EachFreeLine);

		var _this = _possibleConstructorReturn(this, (EachFreeLine.__proto__ || Object.getPrototypeOf(EachFreeLine)).call(this, props));
