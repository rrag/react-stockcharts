...
var EachVerticalLine = function (_Component) {
	_inherits(EachVerticalLine, _Component);

	function EachVerticalLine(props) {
		_classCallCheck(this, EachVerticalLine);

		var _this = _possibleConstructorReturn(this, (EachVerticalLine.__proto__ || Object.getPrototypeOf(EachVerticalLine)).call(this, props));
	...
	_createClass(EachVerticalLine, [{
		...
		value: function render() {
			...
			var lines = helper({ x1, x2, y1, y2 });
			console.log("pro",this.props,lines[0])
			...
			var lineType ="LINE"//= type === "EXTEND" ? "XLINE" : type === "BOUND" ? "LINE" : type;
			var dir = (0, _utils.head)(lines).x1 > (0, _utils.last)(lines).x1 ? 3 : -1.3;
...
function helper(_ref2) {
	...
	var dy = y2 - y1;
	var retracements = [100].map(function (each) {
		return {
			percent: each,
			x1,
			x2,
...
exports.default = EachVerticalLine;
//# sourceMappingURL=EachVerticalLine.js.map