...
import CandleStickChartWithInteractiveShape from "lib/charts/CandleStickChartWithInteractiveShape";

class ShapesPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<ContentSection title={ShapesPage.title}>
				<Row>
					<Section colSpan={2}>
						<aside dangerouslySetInnerHTML={{ __html: require("md/Shapes") }}></aside>
					</Section>
				</Row>
				<Row>
					<Section colSpan={2}>
						...
						<TypeChooser>
							{type => <CandleStickChartWithInteractiveShape ref={this.saveNode} data={this.props.someData} type={type} />}
						</TypeChooser>
					</Section>
				</Row>
			</ContentSection>
