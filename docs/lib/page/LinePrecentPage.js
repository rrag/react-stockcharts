...
import CandleStickChartWithInteractiveLinePrecennt from "lib/charts/CandleStickChartWithInteractiveLinePrecennt";

class LinePrecentInteractiveIndicatorPage extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
			<ContentSection title={LinePrecentInteractiveIndicatorPage.title}>
				<Row>
					<Section colSpan={2}>
				...
				<Row>
					<Section colSpan={2}>
						...
						<TypeChooser>
							{type => <CandleStickChartWithInteractiveLinePrecennt ref={this.saveNode} data={this.props.someData} type={type} />}
						</TypeChooser>
					</Section>
				</Row>
			</ContentSection>
...
LinePrecentInteractiveIndicatorPage.title = "Line precent";

export default LinePrecentInteractiveIndicatorPage;
