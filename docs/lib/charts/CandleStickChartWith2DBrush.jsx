...
class CandlestickChart extends React.Component {
	...
	handleBrush(coords, items) {
		...
		var yScale = this.refs.main.yScale();
	...
	render() {
		...
		return (
			<ChartCanvas ref="chartCanvas" width={width} height={600}
				...
				data={data} type={type}>
				<Chart ref="main" id={1} yMousePointerDisplayLocation="right"
						height={400}
						yMousePointerDisplayFormat={d3.format(".2f")}
						padding={{ top: 10, right: 0, bottom: 20, left: 0 }}
						yScale={this.state.yScale}
						yDomainUpdate={this.state.yDomainUpdate}>
					...
					<Brush ref="brush" id={0} enabled={true} onBrush={this.handleBrush}/>
				</Chart>
...
var CandleStickChartWith2DBrush = fitWidth(CandlestickChart)

export default CandleStickChartWith2DBrush;
