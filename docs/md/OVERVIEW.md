...
I am not going to debate between the pros and cons between SVG and Canvas. They are discussed at great length [here](http://stackoverflow.com/questions/12310024/fast-and-responsive-interactive-charts-graphs-svg-canvas-other) and [here](http://stackoverflow.com/questions/5882716/html5-canvas-vs-svg-vs-div). Needless to say they are both very powerful and for charting, there really is no right answer. With React Stockcharts you have the option to go with complete SVG or a hybrid approach of canvas + SVG. in the hybrid approach SVG is used to draw the tooltip while canvas is used for everything else, including the axes, mouse crosshair, the actual chart series etc.
